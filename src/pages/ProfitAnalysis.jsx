      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white border-r border-gray-200 min-h-screen p-6">
          <nav className="space-y-2">
            ...
            <a href="asset-detail" className="flex items-center space-x-3 text-grey-700 p-2 rounded-lg hover:bg-gray-100">
              <FileText className="h-4 w-4" /><span>Asset Detail</span>
            </a>
            <a href="profit-analysis" className="flex items-center space-x-3 text-blue-600 bg-blue-50 p-2 rounded-lg hover:bg-gray-100">
            ...
            <a href="/settings" className="flex items-center space-x-3 text-grey-700 p-2 rounded-lg">
